...
args.MODEL_NAME = (
    "/root/megrez-tmp/rwkv-tcm/3b-train-with-soda-val-disha/merge/v7-3b-disha-10"
)
...
prompt = "System: 你是一个专业的中医医生，正在进行一次完整的中医诊疗对话。以下是患者的基本信息，请根据患者的描述和症状进行专业的问诊和诊断。\n\nUser: 我是患者，主诊：小儿支气管炎\n我的情况：4岁男孩得了手足口病，心跳160去医院查说好着呢，现在咳嗽的厉害是什么原因？"
